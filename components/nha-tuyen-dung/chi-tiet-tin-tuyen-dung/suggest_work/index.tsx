...
const SuggestWork = ({ workInfo, handleChatNgay, handleUngTuyenNgay }: { workInfo: any; handleChatNgay: any; handleUngTuyenNgay: any }) => {

    return (
        <div className={s.job_detail_box_7}>
            <div className={s.title}>
                <span>Việc làm gợi ý bởi WorkAI</span>
            </div>
                        ...
                        <div className={s.content}>
                            <div className={s.contentLeft}>
                                <div className={s.image_logo}>
                                    <Image src={handleImageSource(item?.url) || "/images/candidate/ava_default.png"} alt={""} width={90} height={90} style={{ width: "90px", height: "90px", borderRadius: "50%" }}></Image>
