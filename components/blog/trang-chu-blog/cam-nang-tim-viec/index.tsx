...
const CamNangTimViec = ({ listCamNang }: { listCamNang: any; }) => {
    ...
    return (
        <div className={s.box_blog_4}>
            ...
            <div className={s.box_blog_body_2}>
                {listCamNang?.slice(0, 4).map((item: any, index: any) => {
                    return (
                        <div key={index} className={s.box_item_1}>
                            <div className={s.box_body}>
                                <Image
                                    src={handleImageSource(item?.new_picture) || '/images/blog/trang-chu-blog/cam-nang-tim-viec.png'}
                                    alt={""} width={281} height={199} className={s.image_item_3}
                                ></Image>
                            ...
                            {index != listCamNang.length - 1 ? <div className={s.line}></div> : <></>}
                        </div>
                    )
                })}
