...
const Pagination = ({ totalPage, currentPage, setCurrentPage, handleChangePage, limitPerPage }: { totalPage: any; currentPage: number; setCurrentPage: any; handleChangePage: any; limitPerPage: any }) => {
