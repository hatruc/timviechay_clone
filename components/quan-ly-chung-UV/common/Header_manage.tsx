...
const Header_manage = () => {
    ...
    const { candiAllowSearch, setCandiAllowSearch, setCandiAllowEmployerSearch } = useContext(NTD_UV_Context)
    // const [showCandiAllowSearch, setShowCandiAllowSearch] = useState(candiAllowSearch == '1' ? true : false)
    ...
    // console.log('>>> check candiAllowSearch: ', candiAllowSearch);
    ...
    return (
        <div className={s.heaeder_manage}>
            ...
            <div className={s.heaeder_right}>
                ...
                {/* <a href="#">Bảng giá</a> */}
                {/* <a href="/nha-tuyen-dung/dang-tin-moi">Đăng tin</a> */}
                <Link href={"/ung-vien/ho-so-xin-viec"}>Hồ sơ xin việc</Link>
                <Link href="/tin-tuyen-dung">Tìm việc làm</Link>
