...
import styles from './unfinish-cv-website.module.scss'
...
const AdminUnfinishCvWebsiteCandidate = () => {
    ...
    const columns: ProColumns<any>[] = [
        ...
        {
            title: 'Địa chỉ',
            dataIndex: 'tmp_distric',
            hideInSearch: true
        },
        {
            title: 'Công việc',
            dataIndex: 'tmp_job_name',
            hideInSearch: true,
        },
        {
            title: 'Nguồn',
...
export default AdminUnfinishCvWebsiteCandidate