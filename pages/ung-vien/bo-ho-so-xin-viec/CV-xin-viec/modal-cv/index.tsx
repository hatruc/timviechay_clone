      ...
      <div className={s.review_container}>
        <div className={s.content}>
          <div className={s.img_cv}>
            <Image
              alt="Xem trước cv"
              src={props.dataCvUser?.name_cv || ""}
              // src="/images/cv/cv-theo-ngon-ngu/avatar1.png"
              width={814}
              height={1159}
            />
          </div>
          <div className={s.right_side}>
            <div className={s.box_right}>
              <div className={s.text}>{props.dataCvUser?.name || ""}</div>
              ...
              {/* <div className={s.color}>
                ...
                <div>
                  <svg
                    ...
                    fill="none"
                  >
                    <rect width="30" height="30" rx="15" fill="#333A44" />
                    <path
              ...
              <div className={s.btn}>
                {/* <Button
                  ...
                  onClick={(e) => {
                    router.push(`/tao-cv/${props.dataCvUser?.cv_title}-${props.dataCvUser?.idcv}`);
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <Button className={s.second_btn} onClick={props.onCancel}>
                  Đóng lại
                </Button>
              </div>
            </div>
