				...
				b.define('select2/utils', ['jquery'], function (a) {
					...
					;(d.prototype.on = function (a, b) {
						...
						(c.hasScroll = function (b, c) {
							...
							return (
								...
								('scroll' === e || 'scroll' === f || d.innerHeight() < c.scrollHeight || d.innerWidth() < c.scrollWidth)
							)
						}),
					...
					return (
						(c.GetUniqueElementId = function (a) {
							...
							return (
								null == b &&
									(a.id ? ((b = a.id), a.setAttribute('data-select2-id', b)) : (a.setAttribute('data-select2-id', ++e), (b = e.toString()))),
								b
							)
						}),
				...
				b.define('select2/selection/search', ['jquery', '../utils', '../keys'], function (a, b, c) {
					...
					return (
						(d.prototype.render = function (b) {
							var c = a(
								'<li style="display: flex; align-items: center; justify-content: center" class="select2-search select2-search--inline"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="textbox" aria-autocomplete="list" /></li>'
							)
					...
					return (
						...
						(d.prototype.option = function (a) {
							...
							a.children
								...
								: ((d = document.createElement('option')), void 0 !== d.textContent ? (d.textContent = a.text) : (d.innerText = a.text)),
						...
						(b.prototype.bind = function (b, c, d) {
							...
							b.call(this, c, d),
								...
								this.$results.on('scroll', function () {
									...
									if (!e.loading && b) {
										e.$results.offset().top + e.$results.outerHeight(!1) + 50 >= e.$loadingMore.offset().top + e.$loadingMore.outerHeight(!1) &&
											e.loadMore()
									}
								})
						}),
										...
										try {
											...
											try {
												...
												l.debug &&
													...
													console.warn &&
													console.warn(
														'Select2: The language file for "' + M + '" could not be automatically loaded. A fallback will be used instead.'
													)
												continue
											}
										}
									...
									return (
										this.each(function () {
											...
											null == a &&
												window.console &&
												console.error &&
												console.error("The select2('" + b + "') method was called on an element that is not using Select2."),
												(d = a[b].apply(a, g))
										}),
